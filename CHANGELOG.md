...
* Add new API endpoints for qBittorrent version and transfer info ([b494beb](https://github.com/Apollogeddon/distribyted/commit/b494beb9f4136d8b730d0c8a1b62f44b941300cc))
...
* Implement offline banner functionality and improve error handling in API calls ([cb247dc](https://github.com/Apollogeddon/distribyted/commit/cb247dc383697d6b16878e5d92b148baa59480e6))
...
* **web:** Modernize ui with glassmorphic dark theme and mobile fixes ([3c94c6c](https://github.com/Apollogeddon/distribyted/commit/3c94c6cc3f0b69ee6be8bf4fb6702e01f9513c62))
...
* Correct the throttled benchmark's dial race and add-magnet ordering ([426c337](https://github.com/Apollogeddon/distribyted/commit/426c337cadefc39bb83953733c17776a49312f63))
...
* Enhance dashboard UI and logs functionality ([93494f0](https://github.com/Apollogeddon/distribyted/commit/93494f06208abc211ed7f45261ac3a63da73b5f1))
...
* Harden default credential handling (random first-run password, drop query-string login fallback) ([588d69f](https://github.com/Apollogeddon/distribyted/commit/588d69fa9b2f54dd22a2cd0e781726a43df89a6b))
...
* Lock MemoryFile.Seek to prevent a data race with concurrent Read ([00347d8](https://github.com/Apollogeddon/distribyted/commit/00347d8a0266805af495469663e2e7ce4108114d))
...
* Switch Windows CI to winget and retry transient package-install failures ([1a9e794](https://github.com/Apollogeddon/distribyted/commit/1a9e79429cf101597b170fb2cdc1220a98f94ece))
...
* Updated root to allow post and added speed limit calls ([a847596](https://github.com/Apollogeddon/distribyted/commit/a8475963f26376359e718494a9090dcd8082b1ec))
...
* Wait for goroutines to finish before closing resources on shutdown ([905bc8b](https://github.com/Apollogeddon/distribyted/commit/905bc8b38857b14185cb877caec8c22b27786fad))
* Wait for link-retry goroutines before closing the DB on shutdown ([23cc71c](https://github.com/Apollogeddon/distribyted/commit/23cc71ccdbdda02914eb007c4defd1e3f948de47))
...
* Add opt-in responsive reads and fix missing storage capacity wiring ([73d58c7](https://github.com/Apollogeddon/distribyted/commit/73d58c7c4ed8565a84e2129553fb9d9e3a95afd0))
